...
// ── Knowledge base (English answers) ────────────────────────
const KB = [
  {
        keywords: ['worship mary', 'worshipping mary', 'worship the virgin', 'mary worship'],
  ...
  {
        keywords: ['pray to saints', 'praying to saints', 'saints intercession', 'dead saints', 'saints are dead'],
  ...
  {
        keywords: ['pope infallible', 'pope not infallible', 'papal infallibility', 'pope wrong'],
  ...
  {
        keywords: ['purgatory bible', 'purgatory not in bible', 'purgatory scripture', 'purgatory unbiblical'],
  ...
  {
        keywords: ['added books', 'deuterocanon', 'apocrypha', 'extra books bible', 'catholic bible books', 'removed books'],
  ...
  {
        keywords: ['confession priest', 'confess priest', 'confession unbiblical', 'why confess priest', 'priest forgive sins'],
  ...
  {
        keywords: ['catholics not saved', 'catholics unsaved', 'are catholics christian', 'catholics going to hell'],
  ...
  {
        keywords: ['statues idolatry', 'images idolatry', 'graven images', 'catholic idols', 'worship statues'],
  ...
  {
        keywords: ['mass sacrifice', 'mass not sacrifice', 'eucharist sacrifice', 'once for all sacrifice', 'mass re-sacrifice'],
  ...
  {
        keywords: ['once saved always saved', 'eternal security', 'lose salvation', 'can you lose salvation', 'assurance of salvation'],
  ...
  {
        keywords: ['sola fide', 'faith alone', 'faith alone saves', 'justified by faith alone'],
  ...
  {
        keywords: ['sola scriptura', 'bible alone', 'scripture alone', 'bible only', 'tradition not in bible'],
 ...
 * @param {string} langCode - language code (currently answers are in English only)
